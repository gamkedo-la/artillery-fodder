...
class buttonsCreate
{
	...
	//Buttons for Campaign Screen
	 ...
	 this.chapter01 = new buttonFactory(120,//canvas.width/2-this._buttonLength/2,
										190,//this._firstButtonPosY,
										this._buttonLength,
										this._buttonSize,
										"Red",
										"Chapter 1",
 	 ...
 	 this.chapter02 = new buttonFactory(220,//canvas.width/2-this._buttonLength/2,
										360,//(this._firstButtonPosY)+ (this._buttonSize + this._padding) * 1,
										this._buttonLength,
										this._buttonSize,
										"Red",
										"Chapter 2",
 	 ...
 	 this.chapter03 = new buttonFactory(540, // canvas.width/2-this._buttonLength/2,
										300, //(this._firstButtonPosY)+ (this._buttonSize + this._padding) * 2,
										this._buttonLength,
										this._buttonSize,
										"Red",
										"Chapter 3",
